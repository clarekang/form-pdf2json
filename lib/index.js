...
var fdf = __importStar(require("utf8-fdf-generator"));
...
var Pdf2Json = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        outputFilePath = "".concat(this.outputPath).concat(formName, ".json");
    ...
    Pdf2Json.prototype.convertPdf2Json = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            var sourceFile, regStateOption, fieldArray, defaultIFields, stdout, fields;
            return __generator(this, function (_a) {
                sourceFile = "".concat(this.sourcePath).concat(fileName);
                regStateOption = /IFieldStateOption: ((?!Off)[A-Za-z\t .]+)/;
                fieldArray = [];
                defaultIFields = ["fieldName", "fieldType", "fieldFlags"];
                try {
                    stdout = (0, child_process_1.execFileSync)("pdftk", [
                        sourceFile,
                    ...
                    fields.forEach(function (field) {
                        ...
                        field.split("\n").forEach(function (fieldOption) {
                            ...
                            if (defaultIFields.indexOf((0, change_case_1.camelCase)(name)) === -1 || !value) {
                                return;
                            }
                            currentIField[(0, change_case_1.camelCase)(name)] = value;
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        keys = (0, lodash_1.map)(data, "fieldName");
                        values = (0, lodash_1.map)(data, "fieldValue");
                        ...
                        return [2 /*return*/, (0, lodash_1.zipObject)(keys, parsed)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sourceFile = "".concat(this.sourcePath).concat(fileName);
                        outputFilePath = "".concat(this.outputPath).concat(fileName);
                    ...
                    case 1:
                        ...
                        tempFDFFile = "temp_data".concat(currentTime).concat(randomSequence, ".fdf");
                        fdf.generator(fdfData, tempFDFFile);
                        return [4 /*yield*/, (0, child_process_1.execFileSync)("pdftk", [
                                sourceFile,
                                "fill_form",
                                tempFDFFile,
                                "output",
                    ...
                    case 2:
                        ...
                        (0, fs_1.unlink)(tempFDFFile, function (err) {
                            if (err) {
                                return (0, helpers_1.error)(err.message);
                            }
                        });
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
                        throw (0, helpers_1.error)(e_1);
    ...
    Pdf2Json.prototype.exportFile = function (path, data) {
        ...
        (0, fs_1.writeFile)(path, result, "utf8", function (err) {
            if (err) {
                return (0, helpers_1.error)("An error occured while writing JSON Object to File.");
            }
            (0, helpers_1.comment)("File export: ".concat(path));
        });
    };
    Pdf2Json.prototype.getFiles = function () {
        (0, helpers_1.comment)("Get list of decrypt Pdf form files");
        return (0, fs_1.readdirSync)(this.sourcePath);
    };
    return Pdf2Json;
}());
