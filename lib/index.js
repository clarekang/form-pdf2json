...
var utf8_fdf_generator_1 = __importDefault(require("utf8-fdf-generator"));
    ...
    Pdf2Json.prototype.convertPdf2Json = function (fileName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    stdout = child_process_1.execFileSync("pdftk", [
                        sourceFile,
                    ...
                    fields.forEach(function (field) {
                        ...
                        field.split("\n").forEach(function (fieldOption) {
                            ...
                            if (defaultIFields.indexOf(change_case_1.camelCase(name)) === -1 || !value) {
                                return;
                            }
                            currentIField[change_case_1.camelCase(name)] = value;
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        utf8_fdf_generator_1.default.generator(fdfData, tempFDFFile);
                        return [4 /*yield*/, child_process_1.execFileSync("pdftk", [
                                sourceFile,
                                "fill_form",
                                tempFDFFile,
                                "output",
